...
export const SearchBar = ({ onSearch }: SearchSarProps) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex items-center w-screen max-w-2xl">
            <input
                type="text"
            ...
            <button
                type='submit'
                className="bg-red-600 text-white py-2 px-4 md:px-6 rounded-r hover:bg-red-900 focus:outline-none">
                Search
            </button>
        </form>
    )
